...
| File | What it is |
|---|---|
| [`learned_binary_address_machine.md`](learned_binary_address_machine.md) | The living design doc — every cycle, result, and verification verdict (56 sections) |
...
| [`blmrs/`](blmrs/) | **The Rust core** — `blmrs` (simple), `blmrs-strong` (strong; the enwik8 headline), `blmrs-dna` (genomes at chromosome scale, §55), and `blmrs-induced` (discovers the unit itself: byte/codon, §56) |
